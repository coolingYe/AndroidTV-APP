...
public class UpgradeTipDialog extends Dialog implements View.OnFocusChangeListener{
    ...
    private OnCountDoneListener onCountDoneListener;
    ...
    public void startConfirmCountDown(int countDown){
    ...
    private void handleConfirmCountDown(){
        ...
        confirmView.postDelayed(() -> {
            countDown--;
            if (countDown == 0) {
                if (onCountDoneListener != null) {
                    onCountDoneListener.onCountDone();
                }
            } else if (countDown > 0){
                handleConfirmCountDown();
            }
    ...
    public void setOnCountDoneListener(OnCountDoneListener onCountDoneListener) {
        this.onCountDoneListener = onCountDoneListener;
    }
