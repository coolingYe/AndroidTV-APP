...
public class PluginDiskCacheManager {

    @SuppressLint("StaticFieldLeak")
    private static PluginDiskCacheManager instance;
    private DiskLruCache diskLruCache;
    private final Context context;

    private PluginDiskCacheManager(Context context){
        this.context = context;
        if(diskLruCache==null){
            try {
                File directory = DiskCacheHelper.getPluginCacheDirectory(context);
    ...
    public static PluginDiskCacheManager init(Context context){
        if(instance==null){
            synchronized (PluginDiskCacheManager.class){
                if(instance==null){
                    instance = new PluginDiskCacheManager(context.getApplicationContext());
                }
            }
        }
        return instance;
    ...
    public static PluginDiskCacheManager getInstance(){
        return instance;
    }
