...
public class CacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if(reqUrl.contains(BaseConstants.ApiPath.SW_VERSION_LATEST)
                || reqUrl.contains(BaseConstants.ApiPath.SW_VERSION_NEWER)
                || reqUrl.contains(BaseConstants.ApiPath.THEME_PACKAGE_INFO)
                || reqUrl.contains(BaseConstants.ApiPath.UMS_SERVICE_PACKAGE_INFO)){
