    ...
    public static String getHostSpString(String key, String defValue){
        if (BuildConfig.FLAVOR.contains("plugin")) {
            ...
            if("UserToken".equals(key)){
                return "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbklkIjoiMzExMTU1OTUzMjMwNDgzNDYwIiwidXNlcklkIjoyNDg4NzE4OTA5MjY2MjA2NzksInVzZXJDb2RlIjoibGFib3JfdW5pb25fMDAxIiwiZXhwaXJlVGltZSI6IjIwNDQtMDEtMTAgMTE6NDU6MjAiLCJhcHBDb2RlIjoibWFsbF91bXMiLCJ1c2VyVHlwZSI6MiwiaXNzIjoiemVld2FpbiIsImV4cCI6MjMzNjAxMDMyMH0.HwzABTzXKzZLhUVH2BSGRPWqfLx-q8cwDOANafWBb4E";
