...
public class DetailActivity extends BaseActivity implements View.OnFocusChangeListener {
    ...
    private MaterialCardView cardProductDescFrame;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cardProductDescFrame = findViewById(R.id.layout_detail_desc);
        ...
        TextView txtDetailGuessLike = findViewById(R.id.txt_detail_guess_like);
    ...
    private void initClickListener() {
        layoutDownloadDetail.setOnClickListener(v -> {
            ...
            if (detailViewModel.publishResp == null) {
        ...
        layoutDownloadDetail.setNextFocusUpId(R.id.txt_product_summary_detail);
        ...
        if (downloadBinder != null) {
            ...
            if (dbDownloadInfo == null) {
                ...
                if (dbDownloadInfo.status == DownloadInfo.STATUS_LOADING || dbDownloadInfo.status == DownloadInfo.STATUS_PENDING) {
                    ...
                    startLoadingApplication();
                    /*if (CameraUtils.getCameraNum(this) > 0) {
                        startLoadingApplication();
                    } else {
                        doWebrtcConnect();
                    }*/
        ...
        upgradeDialog.setOnClickListener(new UpgradeTipDialog.OnClickListener() {
            ...
            public void onPositive(View v) {
                ...
                if (NetworkUtil.isNetworkAvailable(v.getContext())) {
                    if (detailViewModel.upgradeResp != null && detailViewModel.publishResp != null) {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        if (v.getId() == R.id.txt_product_summary_detail) {
            if (hasFocus) {
                cardProductDescFrame.setStrokeColor(0xFFFA701F);
                cardProductDescFrame.setStrokeWidth(DisplayUtil.dip2px(v.getContext(), 1));
            } else {
                cardProductDescFrame.setStrokeColor(0x00FFFFFF);
                cardProductDescFrame.setStrokeWidth(0);
            }
        } else {
            if (hasFocus) {
