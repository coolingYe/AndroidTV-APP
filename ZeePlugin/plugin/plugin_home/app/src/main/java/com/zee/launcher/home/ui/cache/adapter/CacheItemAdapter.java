...
public class CacheItemAdapter extends RecyclerView.Adapter<CacheItemAdapter.UserProductViewHolder> {
    ...
    @NonNull
    @Override
    public CacheItemAdapter.UserProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_user_product, parent, false);
        return new CacheItemAdapter.UserProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CacheItemAdapter.UserProductViewHolder holder, int position) {
