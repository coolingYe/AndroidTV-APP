...
public class InteractiveRecordFragment extends BaseUserCenterFragment implements UserCommonAdapter.OnItemClickListener, UserRecordListAdapter.OnRemoveItemListenerRoot {
    ...
    public void initListener() {
        ...
        ivUserCommPageDel.setOnClickListener(v -> {
            ...
            ivUserCommPageDel.setImageResource(mDelMode ? R.mipmap.ic_user_product_undel_selected_bg : R.mipmap.ic_user_product_del_selected_bg);
        });

        ivUserCommPageDel.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ivUserCommPageDel.setImageResource(mDelMode ? R.mipmap.ic_user_product_undel_selected_bg : R.mipmap.ic_user_product_del_selected_bg);
            } else {
                ivUserCommPageDel.setImageResource(mDelMode ? R.mipmap.ic_user_product_undel_unselected_bg : R.mipmap.ic_user_product_del_bg);
            }
        });
    ...
    protected void checkState() {
        if (mAdapter.getItemCount() == 0) {
            ...
            ((UserCenterActivity)requireActivity()).onRecycleViewCallback();
        } else {
...
//                mAdapter.updateData(mViewModel.historyResp);//TODO
    ...
    private void showClearAllDialog(Context context) {
        ...
        customAlertDialog.setTitleText("删除历史体验");
