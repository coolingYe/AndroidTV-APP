...
import com.zeewain.base.widgets.GradientTextView;
...
public class UserCenterCategoryAdapter extends RecyclerView.Adapter<UserCenterCategoryAdapter.CategoryViewHolder> {
    ...
    class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public final GradientTextView txtUserCenterCategory;
        ...
        public void bind(UserCenterCategory userCenterCategory, int position) {
            ...
            txtUserCenterCategory.getPaint().setShader(isSelected && recyclerView.hasFocus() ? txtUserCenterCategory.getLinearGradient1() : isSelected ? txtUserCenterCategory.getLinearGradient() : txtUserCenterCategory.getLinearGradient1());
            imgUserCenterCategory.setImageResource(userCenterCategory.iconResId);
            llUserCenterCategory.setTag(position);
            llUserCenterCategory.setOnClickListener(this);
            llUserCenterCategory.setBackgroundResource(isSelected && recyclerView.hasFocus() ? R.mipmap.ic_user_left_item_selected_bg : 0);
        }
        ...
        public CategoryViewHolder(@NonNull View view) {
            ...
            txtUserCenterCategory.setTypeface(FontUtils.typeface);
        }
