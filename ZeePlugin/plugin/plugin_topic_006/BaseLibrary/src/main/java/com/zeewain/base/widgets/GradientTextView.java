...
public class GradientTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public GradientTextView(Context context, AttributeSet attrs) {
        ...
        mStartColor = typedArray.getColor(R.styleable.GradientTextView_startColor, 0xFFFFF6C8);
        mEndColor = typedArray.getColor(R.styleable.GradientTextView_endColor, 0xFFFFCE09);
