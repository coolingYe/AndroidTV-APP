...
public class BaseConstants {
    ...
    public static final String ZEE_SETTINGS_ACTIVITY_CAMERA_GUIDE_ACTION = "com.zee.setting.SHOW_GUIDE_ACTION";
    public static final String ZEE_SETTINGS_ACTIVITY_CAMERA_UNCONNECT_ACTION = "com.zee.setting.SHOW_UNCONNECT_ACTION";
    public static final String ZEE_SETTINGS_UPDATE = "com.zee.setting.update";

    public static final String SP_KEY_CAMERA_UPDATE_STATE = "sp_key_camera_update_state";
    public static final String SP_KEY_CAMERA_FUNCTION_SWITCH = "sp_key_camera_function_switch";
    ...
    public static class ApiPath {
        ...
        public static final String USER_PLAY_RECORD_LIST = "/ums/playHistory/v2/record";
    }
