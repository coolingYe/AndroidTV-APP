    ...
    public static String getHostSpString(String key, String defValue){
        if (BuildConfig.FLAVOR.contains("plugin")) {
            ...
            if("UserToken".equals(key)){
                return "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..3gWLt7PDyInn5XHdyTU3SSYpByw_ZMjkn5YuvnwiMZI";
                ...
                return "SN033393370022245001444";
            } else {
                return null;
            }
        }
