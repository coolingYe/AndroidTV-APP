...
public class UserCenterCategoryAdapter extends RecyclerView.Adapter<UserCenterCategoryAdapter.CategoryViewHolder> {
    ...
    class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(UserCenterCategory userCenterCategory, int position) {
            ...
            cardUserCenterCategory.setStrokeColor(isSelected  ? itemView.getContext().getColor(R.color.all_focused_frame_color) : 0x00FFFFFF);
            cardUserCenterCategory.setStrokeWidth(isSelected && recyclerView.hasFocus() ?
                    DisplayUtil.dip2px(txtUserCenterCategory.getContext(), 2.5f): 0 );
            ...
            llUserCenterCategory.setBackgroundResource(isSelected ? R.drawable.shape_user_center_left_item_selected_bg : Color.TRANSPARENT);
        }
        ...
        public CategoryViewHolder(@NonNull View view) {
            ...
            txtUserCenterCategory.setTextColor(view.getContext().getColor(R.color.user_center_left_item_title_color));
            cardUserCenterCategory.setCardBackgroundColor(view.getContext().getColor(R.color.user_center_left_item_bg_color));
            if (CommonUtils.isTopic003Enable()) {
                txtUserCenterCategory.setTypeface(FontUtils.typefaceMedium);
            }
        }
