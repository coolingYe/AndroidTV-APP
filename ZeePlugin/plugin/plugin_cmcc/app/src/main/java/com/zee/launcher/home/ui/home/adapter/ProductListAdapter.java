...
public class ProductListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class BannerViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ProductListType productListType) {
            ...
            if (productListType.swiperLayout.uid.equals("mixed-swiper")) {
                bannerDataList.addAll(filterImageVideo(productListType.swiperLayout.config.items));
            }
            ...
            if (CommonUtils.isTopic003Enable()) {
                if (index == 1) {
                    clBannerChild.setBackgroundResource(R.drawable.shape_c5_ffd096_ff7717_cmcc1_tab2);
                } else clBannerChild.setBackgroundResource(R.drawable.shape_c5_04d54c_ffe26d_cmcc1);
            }
        }

        private List<ProductListMo.Record> filterImageVideo(List<SwiperLayout.Item> mixedBanners) {
    ...
    class ClassicModuleViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ProductListType productListType, int position) {
            ...
            if (CommonUtils.isTopic003Enable()) {
                if ("最新上线".equals(productListType.listTitle)) {
                    imgTitleIcon.setImageResource(R.mipmap.ic_module_item_new_recommend_cmcc1);
                } else {
                    if (index == 1) {
                        imgTitleIcon.setImageResource(R.mipmap.ic_module_item_hot_recommend_cmcc1_tab2);
                    } else {
                        imgTitleIcon.setImageResource(R.mipmap.ic_module_item_hot_recommend_cmcc1);
                    }
        ...
        public ClassicModuleViewHolder(@NonNull View itemView) {
            ...
            if (CommonUtils.isTopic003Enable()) {
                imgTitleIcon.getLayoutParams().width = DisplayUtil.dip2px(itemView.getContext(), 155);
                imgTitleIcon.getLayoutParams().height = DisplayUtil.dip2px(itemView.getContext(), 37);
            }

            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(itemView.getContext());
            linearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
            recyclerView.setLayoutManager(linearLayoutManager);
            recyclerView.addItemDecoration(new HorizontalItemDecoration(DisplayUtil.dip2px(itemView.getContext(), 16), 0));
        ...
        private void initObserve(ProductListType productListType, final AppCardListLayout appCardListLayout, final int position) {
            ...
            if (CommonUtils.isTopic003Enable()) {
                if (Objects.equals(productListType.listTitle, "最新上线")) {
                    dataList.clear();
                    dataList.add(new ProductListMo.Record("虚拟投篮","", "https://oss.zeewain.com/PRODUCT_IMAGE/b63636c93dea437e99fd073474a55085/%E7%AF%AE%E7%90%83.png"));
                }
            }
