    ...
    public static String getHostSpString(String key, String defValue){
        if (BuildConfig.FLAVOR == "plugin") {
            ...
            if("UserToken".equals(key)){
                return "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbklkIjoiMzE3Njc5MDgxMDg3NjM1NDYyIiwidXNlcklkIjozMTQzOTA2NzU0MDU4NTI2NzQsInVzZXJDb2RlIjoic2hvd3Jvb21fMDAyIiwiZXhwaXJlVGltZSI6IjIwNDQtMDEtMjggMTE6NDU6NTUiLCJhcHBDb2RlIjoibWFsbF91bXMiLCJ1c2VyVHlwZSI6MiwiaXNzIjoiemVld2FpbiIsImV4cCI6MjMzNzU2NTU1NX0.s6nV_C0xjGKMiUuoyP0isP2ysrAh3ByIAwDevLc3Ax8";
