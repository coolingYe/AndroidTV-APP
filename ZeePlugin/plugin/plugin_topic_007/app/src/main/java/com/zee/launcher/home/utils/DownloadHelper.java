...
public class DownloadHelper {
    ...
    public static DownloadInfo buildDownloadInfo(Context context, ProDetailResp proDetailResp, PublishResp publishResp,String describe){
        ...
        downloadInfo.describe = describe;
        return downloadInfo;
    }
