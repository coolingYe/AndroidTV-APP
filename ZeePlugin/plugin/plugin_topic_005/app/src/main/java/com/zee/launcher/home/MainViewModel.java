...
public class MainViewModel extends BaseViewModel {
    ...
    public List<String> getAppSkusByPageIndex(int pageIndex) {
        if(globalLayout.layout.pages.size() > pageIndex) {
            ...
            if (content != null && content.size() > 0) {
                AdvertBean advertPage = new Gson().fromJson(String.valueOf(content.getJSONObject(0)), AdvertBean.class);
                if(advertPage.config != null && advertPage.config.appSkus != null){
    ...
    public List<ProductSkuIdListType> getProductSkuIdListTypeList() {
        ...
        productSkuIdListTypeList.add(new ProductSkuIdListType(String.valueOf(0), getAppSkusByPageIndex(0)));
