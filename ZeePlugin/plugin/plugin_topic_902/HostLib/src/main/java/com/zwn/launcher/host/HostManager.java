    ...
    public static String getHostSpString(String key, String defValue){
        if (BuildConfig.FLAVOR == "plugin") {
            ...
            if("UserToken".equals(key)){
                return "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbklkIjoiMjU1Njg0NzA5MDAxMzE4NDA4IiwiaXNzIjoiemVld2FpbiIsImFwcENvZGUiOiJtYWxsX3VtcyIsInVzZXJJZCI6MTk4MTgxOTAyMTI0NjAxMzQ0LCJ1c2VyQ29kZSI6Inp3eV90ZXN0XzAwMSIsImV4cGlyZVRpbWUiOiIyMDIzLTA4LTI5IDEwOjAyOjI0IiwidXNlclR5cGUiOjIsImV4cCI6MTY5MzI3NDU0NH0.EdoB_hPtVM_ll7LwQHxbbJiSld5QdaPKCJjKlxTq3I0";
