...
public class DetailActivity extends BaseActivity implements View.OnFocusChangeListener{
    ...
    private void initClickListener(){
        ...
        layoutDownloadDetail.setNextFocusUpId(R.id.img_settings_top_bar);
    ...
    private void handleGuessLikeUpdate(){
        ...
        if(detailViewModel.productRecommendList == null || detailViewModel.productRecommendList.size() == 0){
            TextView txtDetailGuessLike = findViewById(R.id.txt_detail_guess_like);
            ...
            recyclerViewGuessLike.setVisibility(View.VISIBLE);
        }
    }
