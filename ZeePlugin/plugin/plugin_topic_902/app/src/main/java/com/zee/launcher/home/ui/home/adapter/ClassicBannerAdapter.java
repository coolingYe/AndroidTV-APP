...
public class ClassicBannerAdapter extends BannerAdapter<ProductListMo.Record, ClassicBannerAdapter.BannerViewHolder>
    ...
    static class BannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private final ImageView imgClassicBannerItemMask;
        ...
        public void bind(ProductListMo.Record record, boolean showTitleSummary){
            ...
            if(showTitleSummary) {
                ...
                imgClassicBannerItemMask.setVisibility(View.VISIBLE);
            }
        }
        ...
        public BannerViewHolder(View view) {
            ...
            imgClassicBannerItemMask = view.findViewById(R.id.img_classic_banner_item_mask);
        }
    }
}
