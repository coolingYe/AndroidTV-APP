...
public class CommonUtils {
    ...
    public static boolean isTopic008Enable() {
        return BuildConfig.FLAVOR_child.equals("topic008");
    }

    public static boolean isTopic009Enable() {
        return BuildConfig.FLAVOR_child.equals("topic009");
    }

    public static boolean isTopic903Enable() {
        return BuildConfig.FLAVOR_child.equals("topic903");
    }
