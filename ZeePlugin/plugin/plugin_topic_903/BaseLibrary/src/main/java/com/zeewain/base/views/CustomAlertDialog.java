...
public class CustomAlertDialog extends AlertDialog implements View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageView.setTypeface(FontUtils.typefaceMedium);
        ...
        if (messageSummaryText != null && CommonUtils.isTopic008Enable()) {
    ...
    private void initChannel() {
        cancelView.setTypeface(FontUtils.typefaceMedium);
        positiveView.setTypeface(FontUtils.typefaceMedium);
        confirmView.setTypeface(FontUtils.typefaceMedium);
    }
