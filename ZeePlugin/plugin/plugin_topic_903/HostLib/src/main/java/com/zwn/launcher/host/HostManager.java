    ...
    public static String getHostSpString(String key, String defValue) {
        if (BuildConfig.FLAVOR == "plugin") {
            ...
            if ("UserToken".equals(key)) {
                return  "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..TmgjraCQDMXOyFjqjLsbgSoO9p13Ye3aKsXtHkPhZ7M";
                ...
                return "SN0333933564646664584002";
            } else {
                return null;
            }
        }
