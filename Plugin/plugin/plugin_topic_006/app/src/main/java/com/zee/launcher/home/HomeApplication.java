...
public class HomeApplication extends BaseApplication {
    ...
    public void onCreate() {
        ...
        FontUtils.initAssetFontBold(this, "fonts/han_sans_bold.otf");
        FontUtils.initAssetFontHeavy(this, "fonts/han_sans_heavy.otf");
        FontUtils.initAssetFontMedium(this, "fonts/han_sans_medium.otf");
        FontUtils.initAssetFontRegular(this, "fonts/han_sans_regular.otf");
    }
