...
public class CommonUtils {
    ...
    public static void startSettingsActivityForCameraUnConnect(Context context){
        try {
            Intent intent = new Intent();
            intent.setAction(BaseConstants.ZEE_SETTINGS_ACTIVITY_CAMERA_UNCONNECT_ACTION);
            context.startActivity(intent);
        } catch (Exception e) {
            e.printStackTrace();
        }
