    ...
    public static String getHostSpString(String key, String defValue){
        if (BuildConfig.FLAVOR == "plugin") {
            ...
            if("UserToken".equals(key)){
                return "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbklkIjoiMjg0MDYxNzc3MTEyNDAzOTc0IiwidXNlcklkIjoyNzA5MDMxMzAzODI4NDgwMDcsInVzZXJDb2RlIjoiM2RfYWR2XzAwMSIsImV4cGlyZVRpbWUiOiIyMDIzLTExLTE1IDE3OjIyOjQ1IiwiYXBwQ29kZSI6Im1hbGxfdW1zIiwidXNlclR5cGUiOjIsImlzcyI6InplZXdhaW4iLCJleHAiOjE3MDAwNDAxNjV9.1pLudW46iX42YJcA6XfkmsG9gKzE6yVziSb0X4KNcsk";
                ...
                return "SN0333933564646664584003";
            } else {
                return null;
            }
        }
