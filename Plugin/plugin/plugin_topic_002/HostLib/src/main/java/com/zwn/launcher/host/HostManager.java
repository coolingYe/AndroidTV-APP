    ...
    public static String getHostSpString(String key, String defValue) {
        if (BuildConfig.FLAVOR == "plugin") {
            ...
            if ("UserToken".equals(key)) {
                return "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbklkIjoiMzEyNTk5NDA2NDIyMzMxMzk1IiwidXNlcklkIjoxODk4MzI1NjMwODE0MzMwOTUsInVzZXJDb2RlIjoiYWlib3hfcmtfMDAxIiwiZXhwaXJlVGltZSI6IjIwNDQtMDEtMTQgMTE6MjE6MDYiLCJhcHBDb2RlIjoibWFsbF91bXMiLCJ1c2VyVHlwZSI6MiwiaXNzIjoiemVld2FpbiIsImV4cCI6MjMzNjM1NDQ2Nn0.-AXP7rMahBfuGYdCRE42XylMq222ComxO9Z26LME8mY";
