...
public class MineDownloadFragment extends BaseUserCenterFragment {
    ...
    public void initView(View view) {
        ...
        cardUserCommPageCache.setVisibility(View.VISIBLE);
    }
    ...
    public void initListener() {
        ...
        cardUserCommPageCache.setOnClickListener(view -> {
            Intent intent = new Intent();
            intent.setAction(BaseConstants.START_CACHE_MANAGER_ACTION);
            view.getContext().sendBroadcast(intent);
        });
        cardUserCommPageCache.setOnFocusChangeListener(this);
    }
    ...
    private void showClearAllDialog(Context context){
        ...
        customAlertDialog.setMessageText("确定要全部删除吗？");
