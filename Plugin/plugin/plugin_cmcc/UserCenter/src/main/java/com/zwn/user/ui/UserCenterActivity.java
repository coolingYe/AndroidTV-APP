...
public class UserCenterActivity extends BaseActivity implements UserCenterCategoryAdapter.OnCategorySelectedListener, View.OnFocusChangeListener, ViewTreeObserver.OnGlobalFocusChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        topBarView.setSettingsBtnNextFocusDownId(R.id.card_user_comm_page_del);
    ...
    private void initChannel() {
        ImageView ivUserAvatar = findViewById(R.id.img_user_center_head);
        ivUserAvatar.setImageResource(R.mipmap.ic_user_center_avatar);
        TextView tvUserLog = findViewById(R.id.txt_user_center_log);
        tvUserLog.setTextColor(getColor(R.color.user_center_log_text_color));
        TextView txtUserCenterUid = findViewById(R.id.txt_user_center_uid);
        txtUserCenterUid.setTextColor(getColor(R.color.user_center_log_text_color));
        View viewLeftBg = findViewById(R.id.v_user_center_left_bg);
        viewLeftBg.setBackgroundResource(R.mipmap.ic_user_center_left_root_bg);
    }

    private void initData(){
        List<UserCenterCategory> categoryList = new ArrayList<>();
        categoryList.add(new UserCenterCategory("历史体验", R.mipmap.uc_history, -1));
        categoryList.add(new UserCenterCategory("我的下载", R.mipmap.uc_download, -1));
        categoryList.add(new UserCenterCategory("我的收藏", R.mipmap.uc_collection, -1));
