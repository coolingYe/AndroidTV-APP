...
public class ClassicBannerIndexAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setSelectIndex(int selectIndex) {
        int lastSelectedIndex = this.selectIndex;
        this.selectIndex = selectIndex;
        if (Math.abs(lastSelectedIndex - this.selectIndex) <= 1) {
            if (lastSelectedIndex < this.selectIndex) {
                notifyItemRangeChanged(lastSelectedIndex, 2);
            } else {
                notifyItemRangeChanged(this.selectIndex, 2);
            }
        } else {
