    ...
    private void initPageCard() {
        ...
        if (pageInfoList.size() > 1) {
            for (final Category category : pageInfoList) {
                ...
                View view = inflate(getContext(), com.zee.launcher.home.R.layout.item_home_first_page_card_layout, null);
                ...
                } else if (category.getCategoryIndex() % 4 == 0) {
                ...
                ImageView imageView = view.findViewById(com.zee.launcher.home.R.id.iv_home_first_page_card_mask);
