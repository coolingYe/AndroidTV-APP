...
public class ProductListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class BannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView tvBannerTip;
        ...
        public void bind(ProductListType productListType) {
            ...
            classicBannerAdapter.setShowTitleSummary(false);
            bannerHome.setAdapter(classicBannerAdapter);

            if (bannerDataList.size() == 1) {
                bannerIndexAdapter.updateDataList(new ArrayList<>());
            } else bannerIndexAdapter.updateDataList(bannerDataList);

            bannerHome.setCurrentItem(bannerIndexAdapter.getSelectIndex() + 1, false);

            if (CommonUtils.isTopic009Enable()) {
                if (viewModel.globalLayout.layout.pages.get(index).name.contains("养生")) {
                    tvBannerTip.setVisibility(View.VISIBLE);
                }
            }
        }
        ...
        public BannerViewHolder(@NonNull View view, int bannerType) {
            ...
            tvBannerTip = view.findViewById(R.id.banner_tip);
    ...
    class ClassicModuleViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ProductListType productListType, int position) {
            ...
            imgTitleIcon.setImageResource(moduleItemIcon[0]);
        }
        ...
        public ClassicModuleViewHolder(@NonNull View itemView) {
            ...
            recyclerView.addItemDecoration(new HorizontalItemDecoration(DisplayUtil.dip2px(itemView.getContext(),
                    CommonUtils.isTopic008Enable() ? 10 : 9), 0));
