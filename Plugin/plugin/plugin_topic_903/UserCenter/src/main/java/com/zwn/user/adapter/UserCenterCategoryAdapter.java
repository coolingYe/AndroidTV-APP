    ...
    class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(UserCenterCategory userCenterCategory, int position) {
            ...
            if (isSelected && recyclerView.hasFocus()) {
                llUserCenterCategory.setBackgroundResource(userCenterCategory.iconSelectedResId);
            }else {
                llUserCenterCategory.setBackgroundResource(userCenterCategory.iconResId);
            }
        }
