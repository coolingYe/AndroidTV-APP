...
import com.zwn.lib_download.BuildConfig;

public class CareSettings {

    public static final class DownloadInfo  {
        public static final Uri CONTENT_URI = Uri.parse("content://" + (BuildConfig.FLAVOR == "plugin" ? CareProvider.AUTHORITY : CareProvider.AUTHORITY_SINGLE)  + "/" + CareProvider.TABLE_DOWNLOAD_INFO );
