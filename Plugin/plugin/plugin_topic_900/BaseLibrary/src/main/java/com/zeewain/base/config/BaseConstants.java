...
public class BaseConstants {
    ...
    public static final String EXTRA_APP_SKU_ID = "AppSkuId";
//    public static final String AdV_APP_PAGE_NAME = "com.linux.vshow";
    public static final String AdV_APP_PAGE_NAME = "net.facelib.eam";
    ...
    public static final int ACTION_APP_START = 0;
    public static final int ACTION_APP_CLOSE = 1;
