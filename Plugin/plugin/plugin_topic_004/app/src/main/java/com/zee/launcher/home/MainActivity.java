...
public class MainActivity extends BaseActivity implements ViewTreeObserver.OnGlobalFocusChangeListener {
    ...
    private void initView(GlobalLayout globalLayout) {
        ...
        if (globalLayout.layout.pages.size() > 0) {
            String imgUrl = globalLayout.layout.pages.get(0).config.preview;
            if (imgUrl != null && !imgUrl.isEmpty()) {
                CommonUtils.setLogoUrl(imgUrl);
                topBarView.setImgUser(imgUrl);
            }
        }
    ...
    private void initToolbar() {
        ...
        mainTabViewBg.setBackgroundResource(R.mipmap.img_main_tab_bg);
    ...
    private void initVerticalLayout() {
        ...
        recyclerViewMainTab.addItemDecoration(new HMainTabItemDecoration(DisplayUtil.dip2px(this, 5)));
    }
...
//                initChannel(position);
    ...
    public static class StartAppReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (akSkInfoString != null && !akSkInfoString.isEmpty() && softwareCode != null && !softwareCode.isEmpty()) {
                Gson gson = new Gson();
