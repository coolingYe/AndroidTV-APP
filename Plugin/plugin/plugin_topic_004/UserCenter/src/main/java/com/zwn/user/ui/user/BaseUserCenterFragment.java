...
public abstract class BaseUserCenterFragment extends Fragment implements View.OnFocusChangeListener{
    ...
    public TextView tvUserCommPageDel, tvUserCommPageDelAll;
    public LinearLayout llUserCommPageDel, llUserCommPageDelAll, llUserCommPageCache;
    public TextView tvUserCommPageCache;
    ...
    public void initView(View view) {
        ...
        llUserCommPageCache = view.findViewById(R.id.ll_user_comm_page_cache_all);
        ...
        tvUserCommPageCache = view.findViewById(R.id.tv_user_comm_page_cache_all);
