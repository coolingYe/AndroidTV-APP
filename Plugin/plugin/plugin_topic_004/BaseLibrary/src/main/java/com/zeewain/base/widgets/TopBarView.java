...
public class TopBarView extends ConstraintLayout implements View.OnFocusChangeListener {
    ...
    public void setImgUser(String imgUrl) {
        GlideApp.with(imgUser)
                .load(imgUrl)
                .transform(new RoundedCorners(DisplayUtil.dip2px(imgUser.getContext(), 24)))
                .into(imgUser);
    }
    ...
    public void updateWifiInfo() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            imgWifi.setBackgroundResource(R.drawable.selector_top_bar_wifi);
        } else {
            imgWifi.setBackgroundResource(R.drawable.selector_top_bar_wifi_err);
        }
    }
