package com.zee.wireless.camera.receiver;
...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    private final WirelessCameraActivity activity;

    public WiFiDirectBroadcastReceiver(WifiP2pManager manager, WifiP2pManager.Channel channel, WirelessCameraActivity activity) {
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            activity.onWifiP2pStateEnabled(state == WifiP2pManager.WIFI_P2P_STATE_ENABLED);
            ...
            if (networkInfo.isConnected()) {
                ...
                activity.resetData(); // It's a disconnect
            }
            ...
            activity.onDiscoveryStateChanged(state);
        }
    }
}
